...
const Blog = () => {
  return (
    <div className="pt-[4rem] md:pt-[8rem] pb-[4rem]">
      <p className="heading">
        My <span className="text-[#FE0039]">BLOG</span>
      </p>
        ...
        <div>
          ...
          <Link href="/">
            <div className="w-[90%] text-center mx-auto bg-[#0a0f14] relative p-[2rem] mt-[1rem] cursor-pointer">
              <div className="w-fit px-[2rem] py-[1rem] bg-[#FE0039] relative mt-[-3rem] text-black font-semibold text-[17px] mx-auto">
                December 10,2023
              </div>
              <div className="flex flex-col md:flex-row items-center mt-[1rem] space-x-4">
                <div className="flex items-center space-x-3">
                  <UserCircleIcon className="w-[1.5rem] mx-auto h-[2rem] text-[#FE0039]" />
                  <p className="text-[#ADB7BE]">By Basit</p>
                </div>
                <div className="flex items-center space-x-3">
                  <ChatBubbleLeftRightIcon className="w-[1.5rem] mx-auto h-[2rem] text-[#FE0039]" />
